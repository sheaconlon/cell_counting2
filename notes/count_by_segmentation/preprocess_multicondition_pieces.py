"""Preprocesses the ``multicondition_pieces`` dataset.
...
Run ``python preprocess_multicondition_pieces.py -h`` to see usage details.
"""
...
if __name__ == "__main__":
    ...
    # ===============================
    PATCH_SIZE = 31 * (1452/2448)  # to match multicondition preprocessing

    parser = argparse.ArgumentParser(
        description="Preprocess the multicondition_pieces dataset.")
    ...
    data_path = os.path.join(args.outdir, "multicondition_pieces_dataset")
    loader_path = os.path.join(repo_path, "data", "multicondition_pieces",
                               "load.py")
